...
def train(args):
    ...
    predictor = task.fit(
        ...
        eval_metric=None, #args.eval_metric,
        ...
        #hyperparameters = {'NN': {}}, # Testing NN
        enable_fit_continuation=args.enable_fit_continuation,
...
#                               "Disabled if `num_bagging_folds >= 2`."))
    ...
    parser.add_argument('--enable_fit_continuation', type='bool', default=False,
